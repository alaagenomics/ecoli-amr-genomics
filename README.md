...
The analysis compares the reference strain *E. coli* K-12 MG1655 with *E. coli* AR Bank #0346, an isolate from the CDC & FDA Antibiotic Resistance Isolate Bank. The project combines genome quality assessment, genome annotation, AMR determinant detection, genomic replicon analysis, genomic-context inspection, and whole-genome distance analysis.

The main objective was to characterize the AMR determinants detected in AR Bank #0346, compare its AMR profile with K-12 MG1655, and examine how detected determinants are distributed across chromosomal and plasmid replicons.

---

## Research question

How do antimicrobial resistance determinants differ between *E. coli* K-12 MG1655 and AR Bank #0346, and how are the detected determinants distributed across chromosomal and plasmid replicons?
...
Raw genome files are not included in this repository. The analysis scripts reference the expected local input paths.
...
The main Bash workflow automates:

1. Genome quality assessment with QUAST
2. Genome annotation with Bakta
3. AMR determinant detection with AMRFinderPlus

Additional Bash and Python scripts process AMR results, compare resistance profiles, analyze genomic replicons, construct a neighbor-joining tree from Mash-based whole-genome distances, and generate figures.
...
The complete assemblies contained no ambiguous bases in the evaluated QUAST metrics.
...
Bakta annotation outputs are retained selectively in the repository to provide useful annotation results without committing every intermediate file generated by the software.
...
The AR Bank #0346 genome contained 18 unique AMR determinants identified by AMRFinderPlus, while no AMR determinants were detected in K-12 MG1655 using the same analysis.

These results represent sequence-based AMR determinant detection. They do not directly measure gene expression or antimicrobial susceptibility phenotype.
...
The plasmid-associated observations describe the genomic location of detected determinants. They do not by themselves establish plasmid-mediated expression, transferability, or horizontal gene transfer.
...
Generated Bakta intermediate files are also excluded from version control, while selected annotation outputs are retained as project results.
...
Additional scripts perform AMR result processing, visualization, and Mash-based distance and tree analysis.
...
Potential future extensions include analysis of additional *E. coli* isolates, larger-scale AMR comparisons, sequence typing, core-genome analysis, and more detailed investigation of resistance-associated genomic regions.
...
It provides a foundation for further work involving bacterial whole-genome sequencing, AMR surveillance, genomic epidemiology, and bioinformatics-based investigation of resistance-associated genomic features.
